<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UcMaestria.ascx.cs" Inherits="FondosycCondonacion.UI.Condonacion.UcMaestria" %>
...
<head>
    ...
    <title>Explicacion de Condonacion - Maestría</title>
    <script>
        $(function () {
            $("#accordion").accordion(
                {
...
<body>
    ...
    <div style="text-align: center;">
        <img src="../Images/ExplicativoCondonacionMaestria.png" usemap="#mapImgMaestria1">
        <map name="mapImgMaestria1">
            <area target="_self" alt="Ver información" title="Ver información" style="cursor: pointer;" onclick="FindSection(0)" coords="244,145,369,191" shape="rect">
            <area target="_self" alt="Ver información" title="Ver información" style="cursor: pointer;" onclick="FindSection(1)" coords="244,212,369,258" shape="rect">
            <area target="_self" alt="Ver información" title="Ver información" style="cursor: pointer;" onclick="FindSection(2)" coords="63,288,143,334" shape="rect">
            <area target="_self" alt="Ver información" title="Ver información" style="cursor: pointer;" onclick="FindSection(3)" coords="148,288,226,334" shape="rect">
            <area target="_self" alt="Ver información" title="Ver información" style="cursor: pointer;" onclick="FindSection(4)" coords="231,288,324,334" shape="rect">
            <area target="_self" alt="Ver información" title="Ver información" style="cursor: pointer;" onclick="FindSection(5)" coords="330,288,422,334" shape="rect">
            <area target="_self" alt="Ver información" title="Ver información" style="cursor: pointer;" onclick="FindSection(6)" coords="427,287,550,333" shape="rect">
            <area target="_self" alt="Ver información" title="Ver información" style="cursor: pointer;" onclick="FindSection(7)" coords="239,460,370,522" shape="rect">
            <area target="_self" alt="Ver información" title="Ver información" style="cursor: pointer;" onclick="FindSection(8)" coords="307,540,228,577,306,616,386,577" shape="poly">
            <area target="_self" alt="Ver información" title="Ver información" style="cursor: pointer;" onclick="FindSection(9)" coords="81,535,177,593" shape="rect">
            <area target="_self" alt="Ver información" title="Ver información" style="cursor: pointer;" onclick="FindSection(10)" coords="238,636,364,682" shape="rect">
            <area target="_self" alt="Ver información" title="Ver información" style="cursor: pointer;" onclick="FindSection(11)" coords="132,729,472,776" shape="rect">
            <area target="_self" alt="Ver información" title="Ver información" style="cursor: pointer;" onclick="FindSection(12)" coords="27,804,104,850" shape="rect">
            <area target="_self" alt="Ver información" title="Ver información" style="cursor: pointer;" onclick="FindSection(13)" coords="133,804,209,850" shape="rect">
            <area target="_self" alt="Ver información" title="Ver información" style="cursor: pointer;" onclick="FindSection(14)" coords="234,804,323,850" shape="rect">
            <area target="_self" alt="Ver información" title="Ver información" style="cursor: pointer;" onclick="FindSection(15)" coords="342,805,432,850" shape="rect">
            <area target="_self" alt="Ver información" title="Ver información" style="cursor: pointer;" onclick="FindSection(16)" coords="455,805,576,850" shape="rect">
            <area target="_self" alt="Ver información" title="Ver información" style="cursor: pointer;" onclick="FindSection(17)" coords="133,974,472,1019" shape="rect">
            <area target="_self" alt="Ver información" title="Ver información" style="cursor: pointer;" onclick="FindSection(18)" coords="9,1042,80,1088" shape="rect">
            <area target="_self" alt="Ver información" title="Ver información" style="cursor: pointer;" onclick="FindSection(19)" coords="85,1042,156,1088" shape="rect">
            <area target="_self" alt="Ver información" title="Ver información" style="cursor: pointer;" onclick="FindSection(20)" coords="161,1042,245,1087" shape="rect">
            <area target="_self" alt="Ver información" title="Ver información" style="cursor: pointer;" onclick="FindSection(21)" coords="251,1042,335,1088" shape="rect">
            <area target="_self" alt="Ver información" title="Ver información" style="cursor: pointer;" onclick="FindSection(22)" coords="340,1042,426,1088" shape="rect">
            <area target="_self" alt="Ver información" title="Ver información" style="cursor: pointer;" onclick="FindSection(23)" coords="431,1041,514,1087" shape="rect">
            <area target="_self" alt="Ver información" title="Ver información" style="cursor: pointer;" onclick="FindSection(24)" coords="520,1042,605,1088" shape="rect">
            |<area target="_self" alt="Ver información" title="Ver información" style="cursor: pointer;" onclick="FindSection(25)" coords="242,1128,373,1186" shape="rect">
            <area target="_self" alt="Ver información" title="Ver información" style="cursor: pointer;" onclick="FindSection(26)" coords="307,1210,229,1244,307,1281,385,1244" shape="poly">
            <area target="_self" alt="Ver información" title="Ver información" style="cursor: pointer;" onclick="FindSection(27)" coords="96,1215,193,1271" shape="rect">
            <area target="_self" alt="Ver información" title="Ver información" style="cursor: pointer;" onclick="FindSection(28)" coords="239,1301,365,1347" shape="rect">
        </map>
    </div>
    <br />
    <div id="accordion">
        ...
        <div align="left">
            <p>
                El ingreso a la plataforma web dispuesta por el ICETEX para atender los temas de condonación de la Convocatoria, requiere para acceder, el mismo usuario y contraseña registrados ante el ICETEX para todos los trámites de su crédito condonable, Estados de Cuenta, Renovaciones, etc. En caso de no tener un usuario registrado deberá hacerlo a través de la opción "¿No se ha registrado? Hágalo aquí ".<br />
                El link a través del cual podrá acceder a la plataforma es:
                    <br />
                <a style="background-color: #fff; color: #0000EE; text-decoration: underline;" target="_blank" href="http://www.icetex.gov.co/dnnpro5/es-co/fondos/fondosparaeldesarrollodeti/primeraconvocatoriagobiernoelectr%C3%B3nico.aspx">http://www.icetex.gov.co/dnnpro5/es-co/fondos/fondosparaeldesarrollodeti/primeraconvocatoriagobiernoelectr%C3%B3nico.aspx</a>
            </p>
        </div>
        <h3><b>2. Seleccionar la Opción de condonación</b></h3>
        <div align="left">
            <p>
                Cada beneficiario que haya cursado una <b>maestría</b> debe obligatoriamente cumplir <b>solo con UNO (1) de los requisitos que se listan a continuación:</b>
                <br />
                <br />

                &nbsp;&nbsp;&nbsp;2.1 Elaborar un (1) documento de investigación sobre un tema de Innovación de Gobierno Electrónico.
                    <br />
                &nbsp;&nbsp;&nbsp;2.2 Realizar y acreditar horas de práctica en una Entidad del Estado.
                    <br />
                &nbsp;&nbsp;&nbsp;2.3 Impartir y acreditar horas de capacitación en una Entidad del Estado.
                    <br />
                &nbsp;&nbsp;&nbsp;2.4 Realizar proyecto de grado dirigido por la Institución Universitaria que aplique a una Entidad del Estado.
                    <br />
                &nbsp;&nbsp;&nbsp;2.5 Realizar proyecto, estudio, investigación o desarrollo que aplique a una Entidad del Estado.
            </p>
        </div>
        <h3><b>2.1 Elaborar un (1) documento de investigación sobre un tema de Innovación de Gobierno Electrónico.</b></h3>
        <div align="left">
            <p>
                Elaborar un (1) documento de investigación, como proyecto de grado dirigido por la INSTITUCIÓN UNIVERSITARIA, sobre un tema de interés en Innovación de Gobierno Electrónico.
                <br />
                <br />
                <b>•	Condiciones, evidencias y documentos previos para iniciar el desarrollo del requisito:</b>
                <br />
                <br />
                1)	Contando con la autorización por parte del Centro de Innovación Pública Digital (o quien haga sus veces) del Ministerio TIC, a través del Anexo No. 06: "AUTORIZACIÓN EXPEDIDA POR EL CENTRO DE INNOVACIÓN PÚBLICA DIGITAL PARA INICIAR CON EL DESARROLLO DEL REQUISITO ADICIONAL (INVESTIGACIÓN) QUE PERMITIRÁ EL CUMPLIMIENTO DE UN REQUISITO DE CONDONACIÓN DE LA PRIMERA CONVOCATORIA DE GOBIERNO ELECTRÓNICO" El citado anexo deberá incluir los siguientes datos: 
                <br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(a)	Nombre propuesto para el Proyecto de investigación.
                <br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(b)	Descripción (síntesis) del Proyecto de investigación
                <br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(c)	Objetivo general y objetivos específicos
                <br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(d)	Características del documento a entregar
                <br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(e)	Pertinencia del proyecto con la Estrategia de Gobierno en Línea en relación directa con la Innovación Digital o Gobierno Digital
                <br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(f)	Cronograma de reportes de avance ante el Centro de Innovación
                <br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(g)	Fecha planeada de finalización (Día/Mes/Año)
                <br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(h)	Nombre del director del proyecto de grado y datos de contacto
                <br />
        ...
        <div align="left">
            <p>
                ...
                1)	Contando con la autorización por parte de la Entidad en donde se revierte el conocimiento adquirido en desarrollo del programa académico. Lo anterior, a través del Anexo No. 03: “AUTORIZACIÓN EXPEDIDA POR ENTIDAD DEL ESTADO PARA INICIAR CON EL DESARROLLO DEL REQUISITO ADICIONAL QUE PERMITIRÁ EL CUMPLIMIENTO DE UN REQUISITO DE CONDONACIÓN DE LA PRIMERA CONVOCATORIA DE GOBIERNO ELECTRÓNICO”. El citado anexo deberá incluir los siguientes datos: 
                    <br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(a)	Descripción del tema de la asesoría, acompañamiento o sensibilización.
                    <br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(b)	Justificación de la asesoría, acompañamiento o sensibilización (razón de ser).
                    <br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(c)	Pertinencia del tema (asesoría, acompañamiento o sensibilización) en relación con la Estrategia de Gobierno en Línea.
                    <br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(d)	Objetivo general y objetivos específicos.
                    <br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(e)	Alcance, enfoque y actores implicados.
                    <br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(f)	Metodología.
                    <br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(g)	Fuentes de información.
                    <br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(h)	Actividades o tareas a realizar.
                    <br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(i)	Productos e informes a entregar a la Entidad.
                    <br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(j)	Recursos y facilidades a ser provistos por los actores.
                    <br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(k)	Cronograma planeado.
                    <br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(l)	Fecha planeada de finalización (Día/Mes/Año).
                    <br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(m)	Bibliografía.
                    <br />
                <br />
        ...
        <h3><b>2.3 Impartir y acreditar horas de capacitación en una Entidad del Estado.</b></h3>
        <div align="left">
            <p>
                El beneficiario del crédito condonable debe cumplir con 440 horas en desarrollo de capacitaciones a por lo menos quince (15) personas de una Entidad del Estado, en temas del Programa Académico cursado y en relación con la Estrategia de Gobierno en Línea o TI.<br />
                <br />
                ...
                1)	Contando con la autorización por parte de la Entidad en donde se revierte el conocimiento adquirido en desarrollo del programa académico. Lo anterior, a través del Anexo No. 03: “AUTORIZACIÓN EXPEDIDA POR ENTIDAD DEL ESTADO PARA INICIAR CON EL DESARROLLO DEL REQUISITO ADICIONAL QUE PERMITIRÁ EL CUMPLIMIENTO DE UN REQUISITO DE CONDONACIÓN DE LA PRIMERA CONVOCATORIA DE GOBIERNO ELECTRÓNICO”. El citado anexo deberá incluir los siguientes datos: 
                    <br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(a)	Descripción del tema de la capacitación.
                    <br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(b)	Justificación de la capacitación (razón de ser de la capacitación).
                    <br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(c)	Pertinencia del tema de la capacitación en relación con la Estrategia de Gobierno en Línea.
                    <br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(d)	Preguntas problémicas de la capacitación (las preguntas que deben quedar resueltas y tratadas durante la capacitación).
                    <br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(e)	Descripción del público objetivo que se planea capacitar.
                    <br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(f)	Tabla de contenido o temario de la capacitación. 
                    <br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(g)	Cronograma planeado de acuerdo con el contenido o temario.
                    <br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(h)	Fecha planeada de finalización (Día/Mes/Año).
                    <br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(i)	Estrategias metodológicas (Clases magistrales, consultas, lecturas, proyectos, estudios de casos, seguimiento a noticias relacionadas, trabajos dirigidos, ensayos, mapas conceptuales, &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;exposiciones, puestas en común, participación en clase, entre otros). 
                    <br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(j)	Seguimiento y evaluación (Control de lecturas, participación en clase, seguimiento a noticias, trabajos / tareas, exposiciones, pruebas escritas u orales, entre otras).
                    <br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(k)	Productos e informes a entregar a la Entidad beneficiaria.
                    <br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(l)	Bibliografía.
                    <br />
                <br />
                2)	Contando con la autorización por parte del Ministerio de TIC - Dirección de Gobierno en Línea (o quien haga sus veces), en relación con la temática acorde con la Estrategia de Gobierno en Línea. En este caso, la Dirección de Gobierno en Línea podrá poner a disposición de los beneficiarios la posibilidad de impartir capacitaciones requeridas por diversas Entidades del Estado y que son lideradas por la Coordinación de Apropiación de la citada Dirección. Para tal efecto se realizarán convocatorias específicas y con cupos limitados, que serán públicas para los beneficiarios, de acuerdo con perfiles, requerimientos y condiciones especiales. Esta autorización reemplazaría la descrita en el ítem No. 1.
                    <br />
                <br />
                3)	Teniendo la aprobación del aval a través de la plataforma web de Condonación del ICETEX. El aval es otorgado por la Junta Administradora del Fondo de Promoción de Gobierno y Empresa TI previa verificación del diligenciamiento y firma del anexo citado en el numeral anterior.
                    <br />
                <br />
                4)	Asegurándose de prever oportunamente las condiciones requeridas para la entrega y uso (financieras, legales, de uso, etc.) de la totalidad del proyecto.
            </p>
        </div>
        <h3><b>2.4 Realizar proyecto de grado dirigido por la Institución Universitaria que aplique a una Entidad del Estado.</b></h3>
        <div align="left">
            <p>
                El beneficiario del crédito condonable debe realizar un Proyecto de Grado – el que le permite optar por el título en la Institución Universitaria: Tesis, Monografía, Proyecto Aplicado, entre otros, dirigido, guiado y avalado por la misma Institución, en temas con enfoque práctico o de investigación en Gobierno Electrónico o en Línea, el cual pueda ser aplicado o sirva como aporte a una Entidad del Estado.<br />
                <br />
                ...
                <br />
                <br />
                1)	Contando con la autorización por parte de la Entidad en donde se revierte el conocimiento adquirido en desarrollo del programa académico. Lo anterior, a través del Anexo No. 04: “AUTORIZACIÓN EXPEDIDA POR INSTITUCIÓN EDUCATIVA Y ENTIDAD DEL ESTADO PARA INICIAR CON EL PROYECTO DE GRADO QUE PERMITIRÁ EL CUMPLIMIENTO DE UN REQUISITO DE CONDONACIÓN DE LA PRIMERA CONVOCATORIA DE GOBIERNO ELECTRÓNICO”. El citado anexo deberá incluir los siguientes datos: 
                    <br />
        ...
        <h3><b>2.5 Realizar proyecto, estudio, investigación o desarrollo que aplique a una Entidad del Estado.</b></h3>
        <div align="left">
            <p>
                    ...
                    <table border="1" cellpadding="0" cellspacing="0" class="MsoTableGrid" style="width: 441.4pt; border-collapse: collapse; border: none; mso-border-alt: solid black .5pt; mso-yfti-tbllook: 1184; mso-padding-alt: 0cm 5.4pt 0cm 5.4pt;"
                        ...
                        <tr style="mso-yfti-irow: 1; height: 17.0pt">
                            <td style="width: 134.45pt; border: solid black 1.0pt; border-top: none; mso-border-top-alt: solid black .5pt; mso-border-alt: solid black .5pt; padding: 0cm 5.4pt 0cm 5.4pt; height: 17.0pt"
                                ...
                                <p class="MsoNormal" style="margin-bottom: 0cm; margin-bottom: .0001pt; line-height: normal">
                                    <span style="font-size: 10.0pt; font-family: &quot; century gothic&quot; ,sans-serif; mso-fareast-language: ES-CO" class="auto-style1">2.1 Investigación en Innovación<o:p></o:p></span>
                                </p>
                            </td>
                        ...
                        <tr style="mso-yfti-irow: 2; height: 17.0pt">
                            <td style="width: 134.45pt; border: solid black 1.0pt; border-top: none; mso-border-top-alt: solid black .5pt; mso-border-alt: solid black .5pt; padding: 0cm 5.4pt 0cm 5.4pt; height: 17.0pt"
                                width="179">
                                <p class="MsoNormal" style="margin-bottom: 0cm; margin-bottom: .0001pt; line-height: normal">
                                    <span style="font-size: 10.0pt; font-family: &quot; century gothic&quot; ,sans-serif; mso-fareast-language: ES-CO"><span class="auto-style1">2.2 Asesoría</span><b style="mso-bidi-font-weight: normal"><o:p></o:p></b></span>
                                </p>
                            </td>
                            <td style="width: 306.95pt; border-top: none; border-left: none; border-bottom: solid black 1.0pt; border-right: solid black 1.0pt; mso-border-top-alt: solid black .5pt; mso-border-left-alt: solid black .5pt; mso-border-alt: solid black .5pt; padding: 0cm 5.4pt 0cm 5.4pt; height: 17.0pt"
                                width="409">
                        ...
                        <tr style="mso-yfti-irow: 3; height: 17.0pt">
                            <td style="width: 134.45pt; border: solid black 1.0pt; border-top: none; mso-border-top-alt: solid black .5pt; mso-border-alt: solid black .5pt; padding: 0cm 5.4pt 0cm 5.4pt; height: 17.0pt"
                                ...
                                <p class="MsoNormal" style="margin-top: 0cm; margin-right: 0cm; margin-bottom: 0cm; margin-left: 1.1pt; margin-bottom: .0001pt; line-height: normal">
                                    <span style="font-size: 10.0pt; font-family: &quot; century gothic&quot; ,sans-serif; mso-fareast-language: ES-CO"><span class="auto-style1">2.3 Capacitación</span><b style="mso-bidi-font-weight: normal"><o:p></o:p></b></span>
                                </p>
                            </td>
                            <td style="width: 306.95pt; border-top: none; border-left: none; border-bottom: solid black 1.0pt; border-right: solid black 1.0pt; mso-border-top-alt: solid black .5pt; mso-border-left-alt: solid black .5pt; mso-border-alt: solid black .5pt; padding: 0cm 5.4pt 0cm 5.4pt; height: 17.0pt"
                                width="409">
                        ...
                        <tr style="mso-yfti-irow: 4; height: 17.0pt">
                            <td style="width: 134.45pt; border: solid black 1.0pt; border-top: none; mso-border-top-alt: solid black .5pt; mso-border-alt: solid black .5pt; padding: 0cm 5.4pt 0cm 5.4pt; height: 17.0pt"
                                ...
                                <p class="MsoNormal" style="margin-top: 0cm; margin-right: 0cm; margin-bottom: 0cm; margin-left: -6.0pt; margin-bottom: .0001pt; text-indent: 7.1pt; line-height: normal">
                                    <span style="font-size: 10.0pt; font-family: &quot; century gothic&quot; ,sans-serif; mso-fareast-language: ES-CO"><span class="auto-style1">2.4 Proyecto dirigido por la Universidad - Entidad</span><b style="mso-bidi-font-weight: normal"><o:p></o:p></b></span>
                                </p>
                            </td>
                            <td style="width: 306.95pt; border-top: none; border-left: none; border-bottom: solid black 1.0pt; border-right: solid black 1.0pt; mso-border-top-alt: solid black .5pt; mso-border-left-alt: solid black .5pt; mso-border-alt: solid black .5pt; padding: 0cm 5.4pt 0cm 5.4pt; height: 17.0pt"
                                width="409">
                        ...
                        <tr style="mso-yfti-irow: 6; mso-yfti-lastrow: yes; height: 17.0pt">
                            <td style="width: 134.45pt; border: solid black 1.0pt; border-top: none; mso-border-top-alt: solid black .5pt; mso-border-alt: solid black .5pt; padding: 0cm 5.4pt 0cm 5.4pt; height: 17.0pt"
                                width="179">
                                <p class="MsoNormal" style="margin-top: 0cm; margin-right: 0cm; margin-bottom: 0cm; margin-left: 1.1pt; margin-bottom: .0001pt; line-height: normal">
                                    <span style="font-size: 10.0pt; font-family: &quot; century gothic&quot; ,sans-serif; mso-fareast-language: ES-CO"><span class="auto-style1">2.5 Proyecto dirigido y aplicado en la Entidad del Estado</span><b style="mso-bidi-font-weight: normal"><o:p></o:p></b></span>
                                </p>
                            </td>
                            <td style="width: 306.95pt; border-top: none; border-left: none; border-bottom: solid black 1.0pt; border-right: solid black 1.0pt; mso-border-top-alt: solid black .5pt; mso-border-left-alt: solid black .5pt; mso-border-alt: solid black .5pt; padding: 0cm 5.4pt 0cm 5.4pt; height: 17.0pt"
                                width="409">
        ...
        <div align="left">
            <p>
                Una vez desarrollada la opción adicional de condonación el Beneficiario deberá gestionar la entrega, recibo y aceptación en la Entidad del Estado, Institución Educativa y/o Centro de Innovación Pública Digital según sea el caso. Lo anterior se formaliza a través del diligenciamiento de los anexos 7, 8 o 10.
            </p>
        </div>
        <h3><b>4.1 Elaborar un (1) documento de investigación sobre un tema de Innovación de Gobierno Electrónico.</b></h3>
        <div align="left">
            <p>
                <b>Condiciones, evidencias y documentos finales que acreditan el cumplimiento del requisito:</b><br />
                <br />
                Certificación de cumplimiento y entrega a satisfacción expedida por el Ministerio TIC -Centro de Innovación Pública Digital (o quien haga sus veces) Lo anterior, a través del Anexo No. 10: “CONSTANCIA DE RECIBO Y ACEPTACIÓN PARA INVESTIGACIÓN EXPEDIDA POR EL CENTRO DE INNOVACIÓN PÚBLICA DIGITAL PARA LA CONDONACIÓN DE LA PRIMERA CONVOCATORIA DE GOBIERNO ELECTRÓNICO”.
            </p>
        </div>
        <h3><b>4.2 Realizar y acreditar horas de práctica en una Entidad del Estado.</b></h3>
        <div align="left">
            <p>
                <b>Condiciones, evidencias y documentos finales que acreditan el cumplimiento del requisito:</b><br />
                <br />
                Certificación de cumplimiento y entrega a satisfacción expedida por el área donde se desarrolló la asesoría, acompañamiento o sensibilización, de la Entidad beneficiaria. Lo anterior a través del Anexo No. 07: “CONSTANCIA DE RECIBO Y ACEPTACIÓN EXPEDIDA POR ENTIDAD DEL ESTADO PARA LA CONDONACIÓN DE LA PRIMERA CONVOCATORIA DE GOBIERNO ELECTRÓNICO”. El citado anexo deberá incluir los datos que evidencien el cumplimiento de la totalidad de las condiciones y actividades de la asesoría, acompañamiento o sensibilización, siendo necesaria la siguiente información:
                    <br />
        ...
        <h3><b>4.3 Impartir y acreditar horas de capacitación en una Entidad del Estado.</b></h3>
        <div align="left">
            <p>
                <b>Condiciones, evidencias y documentos finales que acreditan el cumplimiento del requisito:</b><br />
                <br />
        ...
        <h3><b>4.4 Realizar proyecto de grado dirigido por la Institución Universitaria que aplique a una Entidad del Estado.</b></h3>
        <div align="left">
            <p>
                <b>Condiciones, evidencias y documentos finales que acreditan el cumplimiento del requisito:</b><br />
                <br />
                Certificación de cumplimiento y entrega a satisfacción del Proyecto de Grado de conformidad por la Entidad del Estado y la Institución Educativa / Universitaria. Lo anterior a través del Anexo No. 08: “CONSTANCIA DE RECIBO Y ACEPTACIÓN EXPEDIDA POR LA INSTITUCIÓN EDUCATIVA Y ENTIDAD DEL ESTADO PARA LA CONDONACIÓN DE LA PRIMERA CONVOCATORIA DE GOBIERNO ELECTRÓNICO”. El citado anexo deberá incluir los datos que evidencien el cumplimiento de la totalidad de las condiciones definidas en el proyecto de grado, siendo necesaria la siguiente información:
                    <br />
                <br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;o	Nombre del beneficiario del crédito condonable y número de identificación.
                    <br />
        ...
        <h3><b>4.5 Realizar proyecto, estudio, investigación o desarrollo que aplique a una Entidad del Estado.</b></h3>
        <div align="left">
            <p>
                <b>Condiciones, evidencias y documentos finales que acreditan el cumplimiento del requisito:</b><br />
                <br />
        ...
        <div align="left">
            <p>
                ...
                Para efectos de la contabilización del tiempo debe considerar la siguiente tabla:<br />
                <center>
<table border="0" cellpadding="0" cellspacing="0" class="MsoNormalTable" style="width: 389.6pt; border-collapse: collapse; mso-yfti-tbllook: 1184; mso-padding-alt: 0cm 3.5pt 0cm 3.5pt"
                    width="519">
                    <tr style="mso-yfti-irow: 0; mso-yfti-firstrow: yes; height: 15.0pt">
                        <td style="width: 135.0pt; border: solid windowtext 1.0pt; mso-border-alt: solid windowtext .5pt; background: #FFE699; padding: 0cm 3.5pt 0cm 3.5pt; height: 15.0pt" width="180">
                            <p align="center" class="MsoNormal" style="margin-bottom: 0cm; margin-bottom: .0001pt; text-align: center; line-height: normal">
                                <b><span style="font-size: 10.0pt; font-family: &quot; century gothic&quot; ,sans-serif; mso-fareast-font-family: &quot; times new roman&quot; mso-fareast-language: ES-CO">SEMESTRES FINANCIADOS<span style="color: black"><o:p></o:p></span></span></b>
                            </p>
                        </td>
                        <td style="width: 254.6pt; border: solid windowtext 1.0pt; border-left: none; mso-border-top-alt: solid windowtext .5pt; mso-border-bottom-alt: solid windowtext .5pt; mso-border-right-alt: solid windowtext .5pt; background: #FFE699; padding: 0cm 3.5pt 0cm 3.5pt; height: 15.0pt" width="339">
                            <p align="center" class="MsoNormal" style="margin-bottom: 0cm; margin-bottom: .0001pt; text-align: center; line-height: normal">
                                <b><span style="font-size: 10.0pt; font-family: &quot; century gothic&quot; ,sans-serif; mso-fareast-font-family: &quot; times new roman&quot; color: black; mso-fareast-language: ES-CO">ACREDITAR TIEMPO MÍNIMO DE VINCULACIÓN<o:p></o:p></span></b>
                            </p>
                            <p align="center" class="MsoNormal" style="margin-bottom: 0cm; margin-bottom: .0001pt; text-align: center; line-height: normal">
                                <b><span style="font-size: 10.0pt; font-family: &quot; century gothic&quot; ,sans-serif; mso-fareast-font-family: &quot; times new roman&quot; color: black; mso-fareast-language: ES-CO">DURANTE LA ETAPA DE ESTUDIO<o:p></o:p></span></b>
                            </p>
                        </td>
                    </tr>
                    <tr style="mso-yfti-irow: 1; height: 15.0pt">
                        <td nowrap style="width: 135.0pt; border: solid windowtext 1.0pt; border-top: none; mso-border-left-alt: solid windowtext .5pt; mso-border-bottom-alt: solid windowtext .5pt; mso-border-right-alt: solid windowtext .5pt; padding: 0cm 3.5pt 0cm 3.5pt; height: 15.0pt"
                            valign="bottom" width="180">
                            <p align="center" class="MsoNormal" style="margin-bottom: 0cm; margin-bottom: .0001pt; text-align: center; line-height: normal">
                                <span style="font-size: 10.0pt; font-family: &quot; century gothic&quot; ,sans-serif; mso-fareast-font-family: &quot; times new roman&quot; color: black; mso-fareast-language: ES-CO">UNO (1)<o:p></o:p></span>
                            </p>
                        </td>
                        <td nowrap style="width: 254.6pt; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-bottom-alt: solid windowtext .5pt; mso-border-right-alt: solid windowtext .5pt; padding: 0cm 3.5pt 0cm 3.5pt; height: 15.0pt"
                            valign="bottom" width="339">
                            <p align="center" class="MsoNormal" style="margin-bottom: 0cm; margin-bottom: .0001pt; text-align: center; line-height: normal">
                                <span style="font-size: 10.0pt; font-family: &quot; century gothic&quot; ,sans-serif; mso-fareast-font-family: &quot; times new roman&quot; color: black; mso-fareast-language: ES-CO">4 MESES<o:p></o:p></span>
                            </p>
                        </td>
                    </tr>
                    <tr style="mso-yfti-irow: 2; height: 15.0pt">
                        <td nowrap style="width: 135.0pt; border: solid windowtext 1.0pt; border-top: none; mso-border-left-alt: solid windowtext .5pt; mso-border-bottom-alt: solid windowtext .5pt; mso-border-right-alt: solid windowtext .5pt; padding: 0cm 3.5pt 0cm 3.5pt; height: 15.0pt"
                            valign="bottom" width="180">
                            <p align="center" class="MsoNormal" style="margin-bottom: 0cm; margin-bottom: .0001pt; text-align: center; line-height: normal">
                                <span style="font-size: 10.0pt; font-family: &quot; century gothic&quot; ,sans-serif; mso-fareast-font-family: &quot; times new roman&quot; color: black; mso-fareast-language: ES-CO">DOS (2)<o:p></o:p></span>
                            </p>
                        </td>
                        <td nowrap style="width: 254.6pt; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-bottom-alt: solid windowtext .5pt; mso-border-right-alt: solid windowtext .5pt; padding: 0cm 3.5pt 0cm 3.5pt; height: 15.0pt"
                            valign="bottom" width="339">
                            <p align="center" class="MsoNormal" style="margin-bottom: 0cm; margin-bottom: .0001pt; text-align: center; line-height: normal">
                                <span style="font-size: 10.0pt; font-family: &quot; century gothic&quot; ,sans-serif; mso-fareast-font-family: &quot; times new roman&quot; color: black; mso-fareast-language: ES-CO">8 MESES<o:p></o:p></span>
                            </p>
                        </td>
                    </tr>
                    <tr style="mso-yfti-irow: 3; height: 15.0pt">
                        <td nowrap style="width: 135.0pt; border: solid windowtext 1.0pt; border-top: none; mso-border-left-alt: solid windowtext .5pt; mso-border-bottom-alt: solid windowtext .5pt; mso-border-right-alt: solid windowtext .5pt; padding: 0cm 3.5pt 0cm 3.5pt; height: 15.0pt"
                            valign="bottom" width="180">
                            <p align="center" class="MsoNormal" style="margin-bottom: 0cm; margin-bottom: .0001pt; text-align: center; line-height: normal">
                                <span style="font-size: 10.0pt; font-family: &quot; century gothic&quot; ,sans-serif; mso-fareast-font-family: &quot; times new roman&quot; color: black; mso-fareast-language: ES-CO">TRES (3)<o:p></o:p></span>
                            </p>
                        </td>
                        <td nowrap style="width: 254.6pt; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-bottom-alt: solid windowtext .5pt; mso-border-right-alt: solid windowtext .5pt; padding: 0cm 3.5pt 0cm 3.5pt; height: 15.0pt"
                            valign="bottom" width="339">
                            <p align="center" class="MsoNormal" style="margin-bottom: 0cm; margin-bottom: .0001pt; text-align: center; line-height: normal">
                                <span style="font-size: 10.0pt; font-family: &quot; century gothic&quot; ,sans-serif; mso-fareast-font-family: &quot; times new roman&quot; color: black; mso-fareast-language: ES-CO">13 MESES<o:p></o:p></span>
                            </p>
                        </td>
                    </tr>
                    <tr style="mso-yfti-irow: 4; mso-yfti-lastrow: yes; height: 15.0pt">
                        <td nowrap style="width: 135.0pt; border: solid windowtext 1.0pt; border-top: none; mso-border-left-alt: solid windowtext .5pt; mso-border-bottom-alt: solid windowtext .5pt; mso-border-right-alt: solid windowtext .5pt; padding: 0cm 3.5pt 0cm 3.5pt; height: 15.0pt"
                            valign="bottom" width="180">
                            <p align="center" class="MsoNormal" style="margin-bottom: 0cm; margin-bottom: .0001pt; text-align: center; line-height: normal">
                                <span style="font-size: 10.0pt; font-family: &quot; century gothic&quot; ,sans-serif; mso-fareast-font-family: &quot; times new roman&quot; color: black; mso-fareast-language: ES-CO">CUATRO (4)<o:p></o:p></span>
                            </p>
                        </td>
                        <td nowrap style="width: 254.6pt; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-bottom-alt: solid windowtext .5pt; mso-border-right-alt: solid windowtext .5pt; padding: 0cm 3.5pt 0cm 3.5pt; height: 15.0pt"
                            valign="bottom" width="339">
                            <p align="center" class="MsoNormal" style="margin-bottom: 0cm; margin-bottom: .0001pt; text-align: center; line-height: normal">
                                <span style="font-size: 10.0pt; font-family: &quot; century gothic&quot; ,sans-serif; mso-fareast-font-family: &quot; times new roman&quot; color: black; mso-fareast-language: ES-CO">17 MESES<o:p></o:p></span>
                            </p>
                        </td>
                    </tr>
                </table>
                ...
                En caso de contar con periodos académicos diferentes, por ejemplo, trimestres, se debe calcular el tiempo mínimo proporcional. Por ejemplo: 1 trimestre es equivalente a 2 meses.<br />
                <br />

                Lo anterior de acuerdo con los semestres reportados y aprobados por la JUNTA ADMINISTRADORA del FONDO  para la obtención del beneficio, de acuerdo con la información oficial registrada en el SNIES para cada Programa Académico y la reportada por las Instituciones Universitarias. Debe corresponder también con los desembolsos realizados por el ICETEX, de acuerdo con las renovaciones realizadas por el beneficiario.<br />
                <br />

                Para el cálculo del tiempo mínimo de vinculación en entidades del Estado, se entiende que dicha vinculación es simultánea al desarrollo de los estudios del Programa Académico elegido. Así mismo, la contratación podrá ser discontinua y/o en diferentes entidades del estado, sin embargo, debe garantizar que la sumatoria de los contratos le permitan el cumplimiento del requisito, no obstante, no podrán ser simultáneos entre sí.<br />
                <br />

                El periodo en el cual podrá acreditar el tiempo mínimo de vinculación directa con una Entidad del Estado se cuenta, desde la fecha de inicio de clases del programa académico elegido y de manera continuar un término máximo doce (12) meses contados a partir de la fecha de terminación de los estudios, es decir las materias, del programa académico financiado . Estas fechas e información relevante las obtiene el ICETEX de manera oficial con cada Institución Educativa.
                    <br />
                <br />

                Nota: En caso de suspensión o aplazamiento de periodo(s) académicos(s), reportados oficialmente ante el ICETEX, ese tiempo no se tendrá en cuenta para ningún efecto, ni como semestre financiado, ni para el tiempo mínimo de vinculación.<br />
                <br />
                ...
                Certificación laboral, en original o copia, con máximo treinta (30) días de expedición, previos a la fecha de radicación de los documentos o, certificación de contratos de prestación de servicios, suscrita por área competente de la Entidad.<br />
                <br />
        ...
        <div align="left">
            <p>
                ...
                <br />
                <br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;o	Diligenciar el formulario de inscripción que está publicado en:
                    <br />
        ...
        <div align="left">
            <p>
                Entregar un video testimonial y creativo de la experiencia como beneficiario de la Primera Convocatoria de Gobierno Electrónico del FONDO DE PROMOCIÓN DE GOBIERNO Y EMPRESA TI.<br />
                <br />

                Las características técnicas del video son:
                    <br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;5)	Tener mínimo dos (2) minutos de testimonio.
                    <br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;6)	Debe ser grabado en formato HD (1080 x 720 pixeles).
                    <br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;7)	La calidad de audio deber ser óptima, nítida y clara (grabado con micrófono externo).
                    <br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;8)	Las condiciones de iluminación deben ser adecuadas. Que no esté subexpuesto o sobreexpuesto.
                ...
                Las condiciones del testimonio son:
                    <br />
                <br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;5)	Realice su presentación personal: nombre, título obtenido y citar PRIMERA CONVOCATORIA DE GOBIERNO ELECTRÓNICO.
                    <br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;6)	Opinar sobre el proceso de vinculación y condonación.
                    <br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;7)	Porqué es útil haber cursado el programa elegido.
                    <br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;8)	Cómo aporta Ud. a la Estrategia de Gobierno en Línea en sus actividades y en su Entidad. Citar la Entidad beneficiaria .
                    <br />
                <br />
                <b>•	Condiciones, evidencias y documentos finales que acreditan el cumplimiento del requisito:</b>
                <br />
                <br />
                Vía web: Se habilita esta nueva opción, que se considera PREFERIBLE, por ser más sencilla y haciendo uso de las TIC. El video debe ser publicado en YouTube y el beneficiario debe informar el enlace web del caso. El citado enlace debe estar vigente por seis (6) meses, contados a partir de la radicación de la solicitud de condonación en la plataforma de condonación de ICETEX. En el sitio del enlace debe citarse el Nombre del beneficiario, Institución, Programa Cursado y nombre de la Convocatoria: PRIMERA CONVOCATORIA DE GOBIERNO ELECTRÓNICO, cumpliendo con las condiciones solicitadas.
                    <br />
                <br />
                En medio magnético o discos ópticos: memoria externa USB, CD o DVD, debidamente marcado con el Nombre del beneficiario, Institución, Programa Cursado y nombre de la Convocatoria: PRIMERA CONVOCATORIA DE GOBIERNO ELECTRÓNICO, cumpliendo con las condiciones solicitadas. Debe ser radicado en el Ministerio de TIC a nombre de la Primera Convocatoria de Gobierno Electrónico, Programa para la Excelencia en Gobierno Electrónico – Dirección de Gobierno en Línea.
                    <br />
                <br />
        ...
        <div align="left">
            <p>
                ...
                <br />
                Las sesiones de la JUNTA se llevarán a cabo, según calendario que será publicado en la plataforma de condonación de la Primera Convocatoria de Gobierno Electrónico en la web del ICETEX. A las sesiones de JUNTA podrán asistir los funcionarios o expertos del Ministerio de TIC que las partes (ICETEX y Ministerio de TIC), consideren necesarios para atender la revisión de la documentación.<br />
                <br />
        ...
        <div align="left">
            <p>
                ...
                <br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1. Anexo 2A - Guía para la Elaboración de Videos  <a style="background-color: #fff; color: #0000EE; text-decoration: underline;" target="_blank" download href="../Plantillas/Anexos/Anexo 2A  Guia para la Elaboración de Videos.pdf">Descargar Anexo 2A</a>
                <br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2. Anexo 2B - Formato para la Documentación de Experiencias  <a style="background-color: #fff; color: #0000EE; text-decoration: underline;" target="_blank" download href="../Plantillas/Anexos/Anexo 2B Formato para la Documentación de Experiencias.docx">Descargar Anexo 2B</a>
                <br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3. Anexo 2C – Formato para el Análisis de Experiencias.  <a style="background-color: #fff; color: #0000EE; text-decoration: underline;" target="_blank" download href="../Plantillas/Anexos/Anexo 2C Formato para el Analisis de Experiencias.docx">Descargar Anexo 2C</a>
                <br />
                <br />
                <b>•	Anexo No. 03:</b> “AUTORIZACIÓN EXPEDIDA POR ENTIDAD DEL ESTADO PARA INICIAR CON EL DESARROLLO DEL REQUISITO ADICIONAL QUE PERMITIRÁ EL CUMPLIMIENTO DE UN REQUISITO DE CONDONACIÓN DE LA PRIMERA CONVOCATORIA DE GOBIERNO ELECTRÓNICO”.
                <br />
                <a style="background-color: #fff; color: #0000EE; text-decoration: underline;" target="_blank" download href="../Plantillas/Anexos/Anexo 03 Autorización Entidades del Estado.docx">Descargar Anexo No. 03</a>
                <br />
                <br />
                <b>•	Anexo No. 04:</b> “AUTORIZACIÓN EXPEDIDA POR INSTITUCIÓN EDUCATIVA Y ENTIDAD DEL ESTADO PARA INICIAR CON EL PROYECTO DE GRADO QUE PERMITIRÁ EL CUMPLIMIENTO DE UN REQUISITO DE CONDONACIÓN DE LA PRIMERA CONVOCATORIA DE GOBIERNO ELECTRÓNICO”.
                <br />
                <a style="background-color: #fff; color: #0000EE; text-decoration: underline;" target="_blank" download href="../Plantillas/Anexos/Anexo 04 Autorización InstituciónEducativa y EntidadEstado.docx">Descargar Anexo No. 04</a>
                <br />
                <br />
                <b>•	Anexo No. 06:</b> “AUTORIZACIÓN EXPEDIDA POR EL CENTRO DE INNOVACIÓN PÚBLICA DIGITAL Y POR LA INSTITUCIÓN EDUCATIVA PARA INICIAR CON EL DESARROLLO DEL REQUISITO ADICIONAL (INVESTIGACIÓN) QUE PERMITIRÁ EL CUMPLIMIENTO DE UN REQUISITO DE CONDONACIÓN DE LA PRIMERA CONVOCATORIA DE GOBIERNO ELECTRÓNICO”.
                <br />
                <a style="background-color: #fff; color: #0000EE; text-decoration: underline;" target="_blank" download href="../Plantillas/Anexos/Anexo 06 Autorización Centro de Innovación Pública para Investigación.docx">Descargar Anexo No. 06</a>
                <br />
                <br />
                <b>•	Anexo No. 07:</b> “CONSTANCIA DE RECIBO Y ACEPTACIÓN EXPEDIDA POR ENTIDAD DEL ESTADO PARA LA CONDONACIÓN DE LA PRIMERA CONVOCATORIA DE GOBIERNO ELECTRÓNICO”.
                <br />
                <a style="background-color: #fff; color: #0000EE; text-decoration: underline;" target="_blank" download href="../Plantillas/Anexos/Anexo 07 Constancia de Recibo y Aceptación Entidades del Estado.docx">Descargar Anexo No. 07</a>
                <br />
                <br />
                <b>•	Anexo No. 08:</b> “CONSTANCIA DE RECIBO Y ACEPTACIÓN EXPEDIDA POR INSTITUCIÓN EDUCATIVA Y ENTIDAD DEL ESTADO PARA LA CONDONACIÓN DE LA PRIMERA CONVOCATORIA DE GOBIERNO ELECTRÓNICO”.
                <br />
                <a style="background-color: #fff; color: #0000EE; text-decoration: underline;" target="_blank" download href="../Plantillas/Anexos/Anexo 08 Constancia de Recibo y Aceptación InstituciónEducativa y EntidadEstado.docx">Descargar Anexo No. 08</a>
                <br />
                <br />
                <b>•	Anexo No. 10:</b> “CONSTANCIA DE RECIBO Y ACEPTACIÓN PARA INVESTIGACIÓN EXPEDIDA POR EL CENTRO DE INNOVACIÓN PÚBLICA DIGITAL Y POR LA INSTITUCIÓN EDUCATIVA PARA LA CONDONACIÓN DE LA PRIMERA CONVOCATORIA DE GOBIERNO ELECTRÓNICO”. 
                <br />
                <a style="background-color: #fff; color: #0000EE; text-decoration: underline;" target="_blank" download href="../Plantillas/Anexos/Anexo 10 Constancia Recibo y Aceptación Centro de Innovación Investigación.docx">Descargar Anexo No. 10</a>
                <br />
                <br />
                ...
                <br />
                <a style="background-color: #fff; color: #0000EE; text-decoration: underline;" target="_blank" download href="../Plantillas/Anexos/Anexo 11 Modelo de Autorización para Uso Promoción y Divulgación del Video PCGE.docx">Descargar Anexo No. 11</a>
            </p>
        </div>
    </div>
</body>
